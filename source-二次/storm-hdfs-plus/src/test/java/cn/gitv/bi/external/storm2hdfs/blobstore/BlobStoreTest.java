 ...
 */
package cn.gitv.bi.external.storm2hdfs.blobstore;
...
public class BlobStoreTest {
  ...
  public void testWithAuthentication(BlobStore store)
    ...
    assertTrue("ACL does not contain WORLD_EVERYTHING", metadata.toString().contains("AccessControl(enumtype:OTHER, access:7)"));
