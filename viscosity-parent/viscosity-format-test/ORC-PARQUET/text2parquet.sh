...
hive <<EOF
use test;
ALTER TABLE parquet_vod_viscosity_user ADD IF NOT EXISTS PARTITION(yyyy='${yyyy}',mm='${mm}',dd='${dd}');
INSERT OVERWRITE TABLE parquet_vod_viscosity_user_other partition(yyyy='${yyyy}',mm='${mm}',dd='${dd}')
