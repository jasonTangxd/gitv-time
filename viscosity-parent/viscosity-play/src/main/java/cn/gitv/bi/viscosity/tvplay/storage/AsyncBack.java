...
public class AsyncBack {
    ...
    public static void user_read_async(final Session session, BoundStatement read, final OutputCollector collector,
        ...
        Futures.addCallback(isExists, new FutureCallback<Long>() {
            ...
            public void onSuccess(Long backCode) {
                if (backCode == 0) {
                    collector.emit(Constant.VOD_TO_USER_INSERT, input,
                            new Values(input.getStringByField("partner"), input.getStringByField("mac"),
                                    input.getStringByField("srcName"), input.getStringByField("chnName"), input.getStringByField("chnId"),
                                    input.getStringByField("albumName"), input.getStringByField("albumId"), input.getStringByField("playOrder"), input.getStringByField("videoId"),
                                    input.getLongByField("playLength"), input.getLongByField("timeLength"),
                                    input.getStringByField("logDate")));
                } else {
                    collector.emit(Constant.VOD_TO_USER_UPDATE, input,
                            new Values(input.getStringByField("partner"), input.getStringByField("mac"),
                                    input.getStringByField("srcName"), input.getStringByField("chnName"), input.getStringByField("chnId"),
                                    input.getStringByField("albumName"), input.getStringByField("albumId"), input.getStringByField("playOrder"), input.getStringByField("videoId"),
                                    input.getLongByField("playLength"), input.getStringByField("logDate")));
                }
                collector.ack(input);
            }
        }, executor);
    ...
    public static void program_read_async(final Session session, BoundStatement read, final OutputCollector collector,
        ...
        Futures.addCallback(isExists, new FutureCallback<Long>() {
            ...
            public void onSuccess(Long backCode) {
                if (backCode == 0) {
                    collector.emit(Constant.VOD_TO_PROGRAM_INSERT, input,
                            new Values(input.getStringByField("partner"), input.getStringByField("srcName"),
                                    input.getStringByField("chnName"), input.getStringByField("chnId"), input.getStringByField("albumName"), input.getStringByField("albumId"),
                                    input.getStringByField("playOrder"), input.getStringByField("videoId"), input.getStringByField("province"),
                    ...
                    collector.emit(Constant.VOD_TO_PROGRAM_UPDATE, input,
                            new Values(input.getStringByField("partner"), input.getStringByField("srcName"),
                                    input.getStringByField("chnName"), input.getStringByField("chnId"), input.getStringByField("albumName"), input.getStringByField("albumId"),
                                    input.getStringByField("playOrder"), input.getStringByField("videoId"), input.getStringByField("province"),
                                    input.getStringByField("city"), input.getLongByField("playLength"),
