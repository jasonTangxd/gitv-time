...
'' as area_name 
from js_cp_user_info where mac!='';
--------------------------------------------
...
mv 000000_0 'js_cp.csv'
拿回这个csv文件，添加一行：
main_account_id,child_account_id,user_id,mac_addr,partner,account_time,record_date,activate_time,first_open,last_open,status,user_type,now_app_version,update_history,province,city_name,area_name
-------------
COPY user_info(main_account_id,child_account_id,user_id,mac_addr,partner,account_time,record_date,activate_time,first_open,last_open,status,user_type,now_app_version,update_history,province,city_name,area_name) FROM '~/Desktop/js_cp.csv' WITH HEADER = true ;