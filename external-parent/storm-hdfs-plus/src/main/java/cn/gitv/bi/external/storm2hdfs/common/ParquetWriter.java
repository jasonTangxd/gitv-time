 ...
 */
package cn.gitv.bi.external.storm2hdfs.common;

import cn.gitv.bi.external.storm2hdfs.bolt.format.RecordFormat;
...
public class ParquetWriter extends AbstractHDFSWriter{
    ...
    public ParquetWriter(FileRotationPolicy policy, Path path, FSDataOutputStream out, RecordFormat format) {
        super(policy, path);
        this.out = out;
        this.format = format;
    }
