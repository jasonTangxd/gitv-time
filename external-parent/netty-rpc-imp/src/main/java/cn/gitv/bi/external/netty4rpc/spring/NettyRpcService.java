...
import cn.gitv.bi.external.netty4rpc.event.ServerStartEvent;
...
public class NettyRpcService implements ApplicationContextAware, ApplicationListener {
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        MessageRecExecutor.getInstance().getHandlerMap().put(interfaceName, applicationContext.getBean(ref));
    }
