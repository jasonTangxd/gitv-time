...
public class Start_up {
    private static final int VOD_MINSIZE = 1024 * 1024 * 128 * 40;//设置minSize 40*128M
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ("vod".equals(type)) {
            ...
            System.out.println("type is not in [vod,liv],removed path and try again");
            System.exit(0);
        }
    ...
    private static void submitJob2(String input, String output, String type) throws Exception {
        ...
        /*设置Map和Reduce处理类*/
        job2.setMapperClass(Job2ChannelMap.class);
        job2.setReducerClass(Job2Top100Reduce.class);
        /*设置map输出类型*/
...
//        job2.submit();
    ...
    /**
     * @param days 通过shell传进来的日期字符串
     * @return 返回需要的hdfs 输入路径
     * 通过shell传进来的日期参数,返回点播的输入路径
     */
